...
namespace ConsoleApp11
{
    class Program
    {
        ...
        {
            var lineSize = MyGetLogicalProcessorInformation().Where(a =>
                 a.ProcessorInformation.Cache.Type == PROCESSOR_CACHE_TYPE.CacheData).Min(
                   a => a.ProcessorInformation.Cache.LineSize);
